...
Company Size:
Medium-sized companies dominate salary spending, contributing the vast majority of total salaries, while large companies contribute far less than expected and small companies contribute minimally.

Experience Level:
Salaries rise progressively from entry-level to executive positions. Entry level earns the lowest, mid-level marks a transition point, senior roles show a strong jump, and executives earn the highest overall.

Employment Type:
Full-time employees earn slightly above the salary benchmark and remain the best paid. Contract workers earn moderately. Freelancers and part-time workers earn the least, showing a major income gap across employment types.

Job Titles:
Data Engineers contribute the largest share of salary totals, followed by Data Scientists. Data Analysts earn significantly less, reflecting their entry-to-mid positioning. ML Engineers contribute the smallest share, likely due to fewer specialized roles but high future growth potential.

Geographical Trends:
Israel, the US, Puerto Rico, Russia, and Canada lead with the highest salary averages. Western Europe shows strong but variable salary levels, while developing regions (India, Vietnam, Macedonia, Bolivia) report much lower averages. Africa shows mixed results, with Nigeria standing out compared to neighboring countries. Some smaller regions (e.g., Bosnia, Puerto Rico) report unusually high salaries.
...
Employment Type:
Full-time employees earn the highest relative to the benchmark, reflecting their priority in organizational structures. Contract staff earn moderately, while freelancers and part-time workers earn significantly less, highlighting a major pay gap that may affect talent attraction and retention.

Job Title (Data Roles):
Data Engineers receive the highest salary share due to the critical need for strong data infrastructure. Data Scientists follow closely, while Analysts earn less as entry-to-mid-level roles. ML Engineers have the smallest share, likely due to fewer roles but strong growth potential as AI adoption rises.
...
Employment Types:
Full-time employees earn around or slightly above the average salary at all experience levels. Contract staff earn moderately, while freelancers and part-time workers earn significantly less especially at mid and senior levels.

Company Size:
Medium-sized companies consistently contribute the largest salary totals at every experience level. Large companies pay far less, and small companies contribute the least.
...
International Labour Organization (ILO). (2023). Global Wage Report.

McKinsey & Company. (2023). State of Data & AI Talent.
